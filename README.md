...
<p align="right">در این ماژول، اطلاعات فاکتور (شماره، مبلغ و کاربر) با تابع encodeHash() رمزگشایی می‌شوند.
<br>
(شما میتوانید حروف را تغییر دهید و از حروف های بیشتر و با جابه جایی بیشتر استفاده کنید . دقت داشته باشید برعکس آنرا نیز حتما در تابع decodeHash قرار دهید تا قابل بازگشایی باشد)
<br>نمونه رمزگذاری داده‌ها:</p>
